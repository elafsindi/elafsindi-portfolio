...
export default function Hero() {
  ...
  return (
    <section className="hero bg-grid fade-in" id="hero">
      {/* Background Orbs */}
      <div className="orb orb-purple hero__orb hero__orb--1" />
      <div className="orb orb-cyan hero__orb hero__orb--2" />
      ...
      <div className="container hero__content">
        ...
        <div className="hero__text">
          ...
          <h1 className="hero__name fade-in" style={{ animationDelay: '0.2s' }}>
            {t.hero.name}
          </h1>

          <div className="hero__role fade-in" style={{ animationDelay: '0.3s' }}>
            <TypewriterText texts={t.hero.roles} />
          </div>

          <p className="hero__description fade-in" style={{ animationDelay: '0.4s' }}>
            {t.hero.description}
          </p>

          <div className="hero__cta fade-in" style={{ animationDelay: '0.5s' }}>
            <button
              id="hero-view-work"
      ...
      {/* Scroll Indicator */}
      <div className="hero__scroll fade-in" style={{ animationDelay: '0.8s' }}>
